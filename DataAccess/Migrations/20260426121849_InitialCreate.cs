        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Concept = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoxMovements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BoxMovements_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BoxMovements_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BoxMovements_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BoxMovements_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoxMovements_AccountId",
                table: "BoxMovements",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_BoxMovements_CompanyId_Number",
                table: "BoxMovements",
                columns: new[] { "CompanyId", "Number" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BoxMovements_TicketId",
                table: "BoxMovements",
                column: "TicketId");

            migrationBuilder.CreateIndex(
                name: "IX_BoxMovements_UserId",
                table: "BoxMovements",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_CompanyId_Number",
                table: "Tickets",
                columns: new[] { "CompanyId", "Number" },
                unique: true);
