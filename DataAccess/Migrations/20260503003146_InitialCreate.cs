        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IVA = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    IIBB = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    FiscalAddress = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    FiscalCity = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ...
                    StartOfActivities = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DefaultSalesPoint = table.Column<int>(type: "integer", nullable: true),
                    CertPath = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CertPassword = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MercadoPagoPreapprovalId = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    MercadoPagoCustomerId = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    MercadoPagoCardToken = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_BoxMovement_Amount", "\"Amount\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoxMovements_CompanyId_MovementDate",
                table: "BoxMovements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoxMovements_CompanyId_RegisteredAt",
                table: "BoxMovements",
                columns: new[] { "CompanyId", "RegisteredAt" });

            migrationBuilder.CreateIndex(
                name: "IX_BoxMovements_CompanyId_Type_Active",
                table: "BoxMovements",
                columns: new[] { "CompanyId", "Type", "Active" });

            migrationBuilder.CreateIndex(
                name: "IX_BoxMovements_MovementDate",
                table: "BoxMovements",
                column: "MovementDate");

            migrationBuilder.CreateIndex(
                name: "IX_BoxMovements_Number",
                table: "BoxMovements",
                column: "Number",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clients_CompanyId_Active",
                table: "Clients",
                columns: new[] { "CompanyId", "Active" });

            migrationBuilder.CreateIndex(
                name: "IX_Clients_CompanyId_CreatedAt",
                table: "Clients",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketHistory_Timestamp",
                table: "TicketHistory",
                column: "Timestamp");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_CompanyId_CreatedAt",
                table: "Tickets",
                columns: new[] { "CompanyId", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_CompanyId_Status_Active",
                table: "Tickets",
